      ...
      <div className="container mx-auto px-6 relative z-10 w-full h-full flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start border-t border-white/10 pt-8">
          ...
          <div className="md:col-span-4 flex flex-col items-start md:items-end gap-4">
            <Link 
              to="/dashboard" 
              className="group flex items-center justify-between w-48 bg-white text-black px-6 py-4 text-sm font-bold tracking-wider hover:bg-neutral-200 transition-colors uppercase"
            >
              <span>Initiate</span>
            ...
            <Link 
              to="/docs" 
              className="group flex items-center justify-between w-48 border border-white/20 text-neutral-400 px-6 py-4 text-[10px] font-mono tracking-wider hover:border-white/40 hover:text-white transition-colors uppercase"
            >
